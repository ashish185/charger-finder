**As a operator I want to create stations and I want to add the chargers too**

- User must have role operator to create the stations
- From UI I gonna provide below details but in camel case.
- create a new file for routes
